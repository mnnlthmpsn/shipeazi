...
import { moving_sizes, storey, yes_or_no } from "../../../utilities/drop_down_items"
import { BookQuestionnaireLayout } from "../layout"
import useResMoveService from "./services"

const ResidentialMove = () => {

    const { getQuote, step, activeStep, isLoading, handleEntityInputChange, handleMoveInputChage } = useResMoveService()

    return (
        <SharedLayout>
            <BookQuestionnaireLayout title="Book a Residential Move">
                        ...
                        <div>
                            ...
                            <div className="md:px-32 xl:px-96 py-4">
                                <div className="grid grid-cols-1 gap-6">
                                    <TextField label='Fullname' name='name' onChange={handleEntityInputChange} />
                        ...
                        <div>
                            ...
                            <div className="md:px-32 xl:px-96 py-4">
                                <div className="grid grid-cols-1 gap-6">
                                    ...
                                    <SelectField label='What is the size of move' name='mov_size' onChange={handleMoveInputChage} options={moving_sizes} />
...
export default ResidentialMove